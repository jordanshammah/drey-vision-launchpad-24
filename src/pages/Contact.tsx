      ...
      <section className="section-padding pt-32 md:pt-40">
        <div className="container-narrow">
          <div className="max-w-3xl">
            <p className="text-sm font-medium text-muted-foreground mb-4 animate-fade-in-up">CONTACT</p>
            ...
            <p className="text-lg md:text-xl text-muted-foreground animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              Have a question or want to learn more about how we can help? 
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">hello@dreyvision.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-foreground text-background flex items-center justify-center shrink-0">
